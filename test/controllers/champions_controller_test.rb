...
class ChampionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create champion" do
    assert_difference('Champion.count') do
      post champions_url, params: { champion: { description: @champion.description, name: @champion.name } }, as: :json
    end
  ...
  test "should update champion" do
    patch champion_url(@champion), params: { champion: { description: @champion.description, name: @champion.name } }, as: :json
    assert_response 200
  end
